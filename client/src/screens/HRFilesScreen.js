...
import { ExportWorkBook } from "../components";
import { YEARS, FILES, MONTHS } from "../util";
import {
  additionRequest,
  newHiresRequest,
  deductionRequest,
      ...
      <Container fluid className="bg-white p-5" style={{ height: "100vh" }}>
        ...
        <div className="mt-5 shadow rounded p-5">
          ...
          <div className="mt-2 d-flex flex-row">
            ...
            />
            <Button color="red" className="mr-3" onClick={this.handleClick}>
              <Icon name="search" inverted />
              Search
            </Button>
            <Button basic onClick={this.resetHandler}>
              <Icon name="redo" />
              Reset
            </Button>
          </div>
        ...
        {dataToExport && (
          <ExportWorkBook name={workBookName} data={dataToExport} />
        )}
      </Container>
    );
  }
